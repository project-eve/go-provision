...
APPS="logmanager ledmanager downloader verifier client server register zedrouter domainmgr identitymgr zedmanager eidregister baseosmgr zedagent hardwaremodel"
if /bin/true; then
    cmdline=""
    for app in $APPS; do
